...
namespace Loteria
{
    public partial class Form1 : Form
    {
        ...
        public async void ObterResultadoLoteria()
        {
            ...
            switch (selectedLoteria)
            {
                case "Mega-Sena":
                    ...
                    lblNumConcurso.Text = $"Concurso {megasena.numero}";
                ...
                case "Quina":
                    ...
                    lblNumConcurso.Text = $"Concurso {quina.numero}";
                ...
                case "Lotofácil":
                    ...
                    lblNumConcurso.Text = $"Concurso {lotofacil.numero}";
                ...
                case "Dupla Sena":
                    ...
                    lblNumConcurso.Text = $"Concurso {duplasena.numero}";
                ...
                case "Lotomania":
                    ...
                    lblNumConcurso.Text = $"Concurso {lotomania.numero}";
                ...
                case "Timemania":
                    ...
                    lblNumConcurso.Text = $"Concurso {timemania.numero}";
                    lblDezenas.Text = $"Dezenas:\n\n{string.Join(" ", timemania.listaDezenas)}";
                    lblTimeCoracao.Text = $"Time do Coração:\n{Regex.Replace(timemania.nomeTimeCoracaoMesSorte, @"\s+", " ")}";
                ...
                case "Federal":
                    ...
                    lblNumConcurso.Text = $"Concurso {federal.numero}";
                    lblDezenas.Text = "";
                ...
                case "Dia de Sorte":
                    ...
                    lblNumConcurso.Text = $"Concurso {diaDeSorte.numero}";
                    ...
                    lblTimeCoracao.Text = $"Mês da Sorte:\n{diaDeSorte.nomeTimeCoracaoMesSorte}";
                ...
                case "Super Sete":
                    ...
                    lblNumConcurso.Text = $"Concurso {superSete.numero}";
                ...
                case "+Milionária":
                    ...
                    lblNumConcurso.Text = $"Concurso {maisMilionaria.numero}";
                    ...
                    lblTimeCoracao.Text = $"Trevos Sorteado:\n{maisMilionaria.trevosSorteados[0]} e {maisMilionaria.trevosSorteados[1]}";
        ...
        private async void btnBuscarResultado_Click(object sender, EventArgs e)
        {
            string selectedLoteria = cbxLoterias.SelectedItem?.ToString();
            ...
            if (cbxLoterias.Text == "")
            {
                MessageBox.Show("Por favor, selecione uma loteria antes de buscar um resultado!.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            else
            {
                if (txtBoxBuscarResultado.Text == "")
                {
                    gpBInfoLoteria.Text = "AGUARDANDO INFORMAÇÕES";
                    lblNumConcurso.Text = "AGUARDANDO INFORMAÇÕES";
                    lblDezenas.Text = "AGUARDANDO INFORMAÇÕES";
                    tabControl1.TabPages.Clear();
                    lblValorEstimado.Text = "";
                    lblDataProxConc.Text = "";
                    lblNumProxConc.Text = "";
                    lblAcumulou.Text = "";
                    MessageBox.Show("Por favor, digite o número do concurso antes de buscar um resultado!.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    return;
                }
                else
                {
                    ...
                    {
                        case "Mega-Sena":
                            var megasena = await loterias.GetPreviousResultAsync<Megasena>("megasena", int.Parse(txtBoxBuscarResultado.Text));
                            if(Int32.Parse(txtBoxBuscarResultado.Text) > megasena.concurso)
                            {
                                MessageBox.Show("O número do concurso informado ainda não foi realizado!.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                return;
                            }
                            else
                            {
                                lblNumConcurso.Text = $"Concurso {megasena.concurso}";
                                lblDezenas.Text = $"Dezenas:\n\n{string.Join(" ", megasena.dezenas)}";
                                gpBInfoLoteria.Text = $"RESULTADOS DO DIA {megasena.data}";
                                txtBoxBuscarResultado.Clear();
                            }
                            break;
                        case "Quina":
                            var quina = await loterias.GetPreviousResultAsync<Quina>("quina", int.Parse(txtBoxBuscarResultado.Text));
                            if (Int32.Parse(txtBoxBuscarResultado.Text) > quina.concurso)
                            {
                                MessageBox.Show("O número do concurso informado ainda não foi realizado!.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                return;
                            }
                            ...
                            {
                                lblNumConcurso.Text = $"Concurso {quina.concurso}";
                                lblDezenas.Text = $"Dezenas:\n\n{string.Join(" ", quina.dezenas)}";
                                gpBInfoLoteria.Text = $"RESULTADOS DO DIA {quina.data}";
                                txtBoxBuscarResultado.Clear();
                            }
                            break;
                        case "Lotofácil":
                            var lotofacil = await loterias.GetPreviousResultAsync<Lotofacil>("lotofacil", int.Parse(txtBoxBuscarResultado.Text));
                            if (Int32.Parse(txtBoxBuscarResultado.Text) > lotofacil.concurso)
                            {
                                MessageBox.Show("O número do concurso informado ainda não foi realizado!.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                return;
                            }
                            ...
                            {
                                lblNumConcurso.Text = $"Concurso {lotofacil.concurso}";
                                lblDezenas.Text = $"Dezenas:\n{string.Join(" ", lotofacil.dezenas.Take(5))}\n{string.Join(" ", lotofacil.dezenas.Skip(5).Take(5))}\n{string.Join(" ", lotofacil.dezenas.Skip(10).Take(10))}";
                                gpBInfoLoteria.Text = $"RESULTADOS DO DIA {lotofacil.data}";
                                txtBoxBuscarResultado.Clear();
                            }
                            break;
                        case "Dupla Sena":
                            var duplasena = await loterias.GetPreviousResultAsync<Duplasena>("duplasena", int.Parse(txtBoxBuscarResultado.Text));
                            if (Int32.Parse(txtBoxBuscarResultado.Text) > duplasena.concurso)
                            {
                                MessageBox.Show("O número do concurso informado ainda não foi realizado!.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                return;
                            }
                            ...
                            {
                                lblNumConcurso.Text = $"Concurso {duplasena.concurso}";
                                lblDezenas.Text = $"Dezenas:\n1° Sorteio: {string.Join(" ", duplasena.dezenas.Take(6))}\n2° Sorteio: {string.Join(" ", duplasena.dezenas.Skip(6))}";
                                gpBInfoLoteria.Text = $"RESULTADOS DO DIA {duplasena.data}";
                                txtBoxBuscarResultado.Clear();
                            }
                            break;
                        case "Lotomania":
                            var lotomania = await loterias.GetPreviousResultAsync<Lotomania>("lotomania", int.Parse(txtBoxBuscarResultado.Text));
                            if (Int32.Parse(txtBoxBuscarResultado.Text) > lotomania.concurso)
                            {
                                MessageBox.Show("O número do concurso informado ainda não foi realizado!.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                return;
                            }
                            ...
                            {
                                lblNumConcurso.Text = $"Concurso {lotomania.concurso}";
                                lblDezenas.Text = $"Dezenas:\n{string.Join(" ", lotomania.dezenas.Take(5))}\n{string.Join(" ", lotomania.dezenas.Skip(5).Take(5))}\n{string.Join(" ", lotomania.dezenas.Skip(10).Take(5))}\n{string.Join(" ", lotomania.dezenas.Skip(15).Take(5))}";
                                gpBInfoLoteria.Text = $"RESULTADOS DO DIA {lotomania.data}";
                                txtBoxBuscarResultado.Clear();
                            }
                            break;
                        case "Timemania":
                            var timemania = await loterias.GetPreviousResultAsync<Timemania>("timemania", int.Parse(txtBoxBuscarResultado.Text));
                            if (Int32.Parse(txtBoxBuscarResultado.Text) > timemania.concurso)
                            {
                                MessageBox.Show("O número do concurso informado ainda não foi realizado!.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                return;
                            }
                            ...
                            {
                                lblNumConcurso.Text = $"Concurso {timemania.concurso}";
                                lblDezenas.Text = $"Dezenas:\n\n{string.Join(" ", timemania.dezenas)}";
                                gpBInfoLoteria.Text = $"RESULTADOS DO DIA {timemania.data}";
                                txtBoxBuscarResultado.Clear();
                            }
                            break;
                        case "Federal":
                            MessageBox.Show($"Em breve {selectedLoteria}!", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                            break;
                        case "Dia de Sorte":
                            var diadesorte = await loterias.GetPreviousResultAsync<DiaDeSorte>("diadesorte", int.Parse(txtBoxBuscarResultado.Text));
                            if (Int32.Parse(txtBoxBuscarResultado.Text) > diadesorte.concurso)
                            {
                                MessageBox.Show("O número do concurso informado ainda não foi realizado!.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                return;
                            }
                            ...
                            {
                                lblNumConcurso.Text = $"Concurso {diadesorte.concurso}";
                                lblDezenas.Text = $"Dezenas:\n\n{string.Join(" ", diadesorte.dezenas)}";
                                gpBInfoLoteria.Text = $"RESULTADOS DO DIA {diadesorte.data}";
                                txtBoxBuscarResultado.Clear();
                            }
                            break;
                        case "Super Sete":
                            var supersete = await loterias.GetPreviousResultAsync<SuperSete>("supersete", int.Parse(txtBoxBuscarResultado.Text));
                            if (Int32.Parse(txtBoxBuscarResultado.Text) > supersete.concurso)
                            {
                                MessageBox.Show("O número do concurso informado ainda não foi realizado!.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                return;
                            }
                            ...
                            {
                                lblNumConcurso.Text = $"Concurso {supersete.concurso}";
                                lblDezenas.Text = $"Dezenas:\n\n{string.Join(" ", supersete.dezenas)}";
                                gpBInfoLoteria.Text = $"RESULTADOS DO DIA {supersete.data}";
                                txtBoxBuscarResultado.Clear();
                            }

                            break;
                        case "+Milionária":
                            var maismilionaria = await loterias.GetPreviousResultAsync<MaisMilionaria>("maismilionaria", int.Parse(txtBoxBuscarResultado.Text));
                            if (Int32.Parse(txtBoxBuscarResultado.Text) > maismilionaria.concurso)
                            {
                                MessageBox.Show("O número do concurso informado ainda não foi realizado!.", "Aviso", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                return;
                            }
                            ...
                            {
                                lblNumConcurso.Text = $"Concurso {maismilionaria.concurso}";
                                lblDezenas.Text = $"Dezenas:\n\n{string.Join(" ", maismilionaria.dezenas)}";
                                gpBInfoLoteria.Text = $"RESULTADOS DO DIA {maismilionaria.data}";
                                txtBoxBuscarResultado.Clear();
                            }
                            break;
                        default:
